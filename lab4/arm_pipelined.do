...
set CACHE_VALID_FILE	./cache_valid.dat
set CACHE_TAG_FILE	./cache_tag.dat
set CACHE_DATA_FILE	./cache_data.dat

# compile source files
vlog wait_state.v control.v cache.v comparator.v cacheram.v imem.v dmem_wait.v arm_pipelined.sv top.sv mux2.v

# start and run simulation
vsim -novopt work.testbench

# initialize memory (start of user memory is 0x3000=12,288)
mem load -startaddress 4000 -i ${MEMORY_FILE} -format hex /testbench/dut/imem/RAM
# Think I can hard code RAM to 0, but was lazy
